...
function RedApto() {
    ...
    if(dato == 0 || productoId == 0){
        ...
        function changeProductAmount() {
            ...
            let url = new URL("https://back-bianca.onrender.com/changeProductAmount/"+id+"/"+productoId+"/"+dato+"/"+ingruma);
    ...
    function getInfoApto() {
        ...
        let url = new URL("https://back-bianca.onrender.com/getAptoById/"+id+"/"+ingruma);
        fetch(url, options) // se hace la consulta 
            .then(response => response.text()) // se obtiene el cuerpo de la respuesta
            .then(data => {
    ...
    function changeName() {
        ...
        let url = new URL("https://back-bianca.onrender.com/changeName/"+id+"/"+nuevoNombre+"/"+ingruma);
        fetch(url, options) // se hace la consulta 
            .then(response => response.text()) // se obtiene el cuerpo de la respuesta
            .then(data => {
